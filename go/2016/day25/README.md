...
need the stars, exactly; it needs the timing data they provide, and you happen to have a
massive signal generator right here.
...
read the data you're sending it. An endless, alternating pattern of
...
You have enough stars to [Transmit the Signal](http://adventofcode.com/2016/day/25/answer).